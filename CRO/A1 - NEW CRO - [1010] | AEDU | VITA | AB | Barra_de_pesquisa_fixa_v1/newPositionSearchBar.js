let callback = {
    newPositionSearchBartPersonalized: false,
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
function applyModificationNewPositionSearchBar() {
    ...
    `;
        ...
        if (destinoSearchBarMobile.querySelector('[data-testid="content-buttons-mobile"]')) {
            ...
            if (!document.querySelector('.cro-force-apply-body-test')) {
...
function modifyNewPositionSearchBar(header) {
    header.classList.add('already-haves-header-NewPositionSearchBar-personalization');

    applyModificationNewPositionSearchBar()

    callback.newPositionSearchBartPersonalized = true;

    const observerNew = new MutationObserver(applyModificationNewPositionSearchBar());

    observerNew.observe(header, { childList: true, subtree: true });
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
function changeLogo() {
...
function startCroNewPositionBar() {
    ...
    if (document.documentElement.classList.contains('already-haves-nova-posição-barra-de-pesquisa')) {
        return;
    }
    ...
    if (!document.documentElement.classList.contains('already-haves-addStyles-new-position-search-bar-novo-ecomm')) {
        addStyles(styles);
    }
    document.documentElement.classList.add('already-haves-addStyles-new-position-search-bar-novo-ecomm');
    ...
    const observer = new MutationObserver(() => {
        if (header && !header.classList.contains('already-haves-header-NewPositionSearchBar-personalization')) {
            modifyNewPositionSearchBar(header);
        }

        if (callback.newPositionSearchBartPersonalized) {
            observer.disconnect();
        }
    });
