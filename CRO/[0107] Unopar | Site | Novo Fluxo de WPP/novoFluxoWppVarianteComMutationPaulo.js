...
function modifyHeader(header) {
    ...
    function applyHeaderModification() {
        ...
        const headerWpp = document.querySelectorAll('[data-testid="top-header-nav-list-item-component-container-link-1"], [data-testid="dropdown-slider-item-list-item-link-item-1"]');

        headerWpp?.forEach(item => {
            item.setAttribute('href', 'https://www.unopar.com.br/whatsapp-redirect/?number=551151071636&message=[Unopar VH] Não altere ou apague esta mensagem. Vim do site da Unopar e quero me inscrever.');
        });
    }
...
function modifyFloater(floater) {
    function applyModification() {
        ...
        if (floaterLink) {
            floaterLink.setAttribute('href', 'https://www.unopar.com.br/whatsapp-redirect/?number=551151071636&message=[Unopar VF] Não altere ou apague esta mensagem. Vim do site da Unopar e quero me inscrever.');
        }
    }
